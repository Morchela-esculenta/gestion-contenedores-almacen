...
const movementService = {
  async log({ referencia, accion, cantidad, fila_numero, zona, stock_anterior, stock_nuevo, nota, combination_key, is_cage }) {
    try {
      const { error } = await sbClient
        ...
        .insert({
          ...
          nota:            nota || null,
          combination_key: combination_key || null,
          is_cage:         is_cage ?? false,
